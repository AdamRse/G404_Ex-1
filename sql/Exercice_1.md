...
`SELECT COUNT(*) as 'Nombre de jeux, AVG(prix) as 'Prix moten' FROM jeux_video WHERE prix >= 40 GROUP BY annee_sortie`
...
`SELECT titre FROM jeux_video WHERE multijoueur = TRUE OR ventes_millions > 30`
